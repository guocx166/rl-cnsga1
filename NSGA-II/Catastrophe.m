function [P1,P2] = Catastrophe(P1,P2,GAParameters,transit_nodes,trans_all,trans,Dis, Capacity,CostTrans,DemandC1,DemandC2,SupplyPoint,TransPoint,DemandPoint,start_time)
...
[ChangePopulationPaths1,ChangePopulationPaths2,ChangePopulationTrans1,ChangePopulationTrans2] = generate(Dis,trans,trans_all,L1, L2, transit_nodes,pop,SupplyPoint,TransPoint,DemandPoint);
    % 替换原种群中的个体  
    % 随机选择n个个体的索引  
